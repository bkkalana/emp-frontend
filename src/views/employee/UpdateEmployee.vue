                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 mt-5">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form @submit.prevent="submitUpdateEmployeeFrom">
                                <div class="card-body">
...
<script>
    ...
    export default {
        ...
        created() {
            this.getEmployeeDetails(this.$router.history.current.query.edit);
            this.getDepartments();
            this.getCountries();
        },
        methods:{
            ...
            getEmployeeDetails(id){
                this.$http.get('http://localhost:8000/employees/'+id+'/edit').then(response => {

                    // get response body data
                    this.employee = response.body.employee;
                    this.getStatesByCountry(this.employee.country_id);
                    this.getCitiesByState(this.employee.state_id);
                }, response => {
                    // error callback
            ...
            getCitiesByState(id){
                this.$http.get('http://localhost:8000/cities/'+id+'/all').then(response => {
            ...
            submitUpdateEmployeeFrom(){

                // POST /countries/create
                this.$http.put('http://localhost:8000/employees/'+this.employee.id, this.employee).then(response => {
