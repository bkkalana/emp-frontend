                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form @submit.prevent="submitUpdateStateFrom">
                                <div class="card-body">
...
<script>
    ...
    export default {
        ...
        created() {
            this.getCountries();
            this.getStateDetails(this.$router.history.current.query.edit);
        },
        methods:{
            getCountries(){
            ...
            getStateDetails(id){
                this.$http.get('http://localhost:8000/states/'+ id+'/edit').then(response => {
            ...
            submitUpdateStateFrom(){

                // POST /countries/create
                this.$http.put('http://localhost:8000/states/'+this.state.id, this.state).then(response => {

                    this.$alert(
                        response.body.message,
                        'Success',
                        "success"
                    ).then(() => this.$router.push({ path: '/states'}));
