        ...
        <div class="col-sm-6 mt-5">
            <div class="card card-primary ">
                ...
                <div class="card-body register-card-body">
                    ...
                    <form @submit.prevent="submitNewUserFrom">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="custom-select form-control-border" v-model="user.role" id="user_role" name="user_role" >
    ...
    export default {
        ...
        methods:{
            ...
            submitNewUserFrom(){
                ...
                this.$http.post('http://localhost:8000/auth/users/create', this.state).then(response => {
